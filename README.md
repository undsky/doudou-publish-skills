...
| **doudou-juejin** | [`skills/doudou-juejin`](./skills/doudou-juejin) | 自动将 Markdown 文章、技术标签与封面发布至 [稀土掘金社区](https://juejin.cn) 草稿箱。 |
| **doudou-csdn** | [`skills/doudou-csdn`](./skills/doudou-csdn) | 自动将 Markdown 原生内容、专栏分类与标签发布至 [CSDN 博客](https://editor.csdn.net/md) 草稿箱。 |
| **doudou-tencent** | [`skills/doudou-tencent`](./skills/doudou-tencent) | 自动将 Markdown 文章、技术标签与封面发布至 [腾讯云开发者社区](https://cloud.tencent.com/developer) 草稿箱。 |
| **doudou-aliyun** | [`skills/doudou-aliyun`](./skills/doudou-aliyun) | 自动将 Markdown 文章及宽屏封面发布至 [阿里云开发者社区](https://developer.aliyun.com) 草稿箱。 |
...
| **doudou-linuxsb** | [`skills/doudou-linuxsb`](./skills/doudou-linuxsb) | 自动将 Markdown 文章与版块填入 [烧饼社区 (Linux.sb)](https://linux.sb/topic_edit?fid=4) 发帖页（保留编辑就绪态供人工审查，不自动触发保存）。 |
