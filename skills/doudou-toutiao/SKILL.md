...
运行辅助解析脚本提取元数据：
```bash
node /Users/jyx/project/doudou-toutiao-skill/scripts/parser.mjs <Markdown文件绝对路径>
```
输出包含：
...
```bash
# 1. 测试资产解析
node /Users/jyx/project/doudou-toutiao-skill/scripts/parser.mjs <Markdown文件路径>

# 2. 测试浏览器代码生成
node /Users/jyx/project/doudou-toutiao-skill/scripts/toutiao_publisher.mjs <Markdown文件路径>
```

### 2. 在 Agent 中配合 `chrome-devtools-mcp` 调用

```javascript
import { parseAllAssets } from '/Users/jyx/project/doudou-toutiao-skill/scripts/parser.mjs';
import { buildPublishBrowserScript } from '/Users/jyx/project/doudou-toutiao-skill/scripts/toutiao_publisher.mjs';
